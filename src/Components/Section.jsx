   ...
   <>
    <section id='section' className='scroll-mt-28'>
        <div className='flex flex-col justify-center items-center gap-7 mt-40'>
            ...
            <div className=' md:flex flex flex-col gap-4  md:gap-3 mt-6 '>
          ...
          <a download href="../../last.pdf"><button  className=' flex border px-10 py-3 gap-3.5 rounded-full'>Resume <span><HiArrowDownTray className='h-5 w-5' /></span></button></a>
        </div>
        </div>
